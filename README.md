# Workday Interactive Planner
 ...
 <strong> This Workday Interactive Planner is a simple calendar application intended for an employee with a busy schedule. <strong> The app runs in the browser using jQuery to dynamically power the HTML and CSS. The user can add important events to the daily planner in order to manage their time effectively.
...
```md
    ![alt text](assets/images/Work_Day_Scheduler.png)
    ```
